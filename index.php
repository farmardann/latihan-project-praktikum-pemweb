  ...
  <body>
          ...
          <div class="card-categories">
            ...
            <div class="card">
              ...
              <div class="card-content">
                <h5>Persia</h5>
                <p class="description">
                  Kucing persia adalah ras kucing domestik berbulu panjang
                  dengan karakter wajah bulat dan moncong pendek. Namanya
                  mengacu pada Persia.
                </p>
                <p class="price"><span>Rp.</span>50,000</p>
                <button
            ...
            <div class="card">
              ...
              <div class="card-content">
                ...
                <p class="description">
                  Kucing bulu pendek britania adalah salah satu ras kucing
                  tertua di inggris. Kucing ini adalah kucing berbadan sedang
                  dengan bulu yang pendek.
                </p>
                <p class="price"><span>Rp.</span>50,000</p>
                <button
                  class="btn_belanja"
                  type="submit"
                  onclick="bukaModal('British Shorthair')"
                >
                  Beli
                </button>
              </div>
          ...
          <div class="modal-dialog" onclick="event.stopPropagation()">
            <div class="modal-content">
              <div class="modal-header">
                <h1 class="modal-title" style="color: #ffb72b">
                  Formulit Pembayaran
                </h1>
                <button
                  type="button"
    ...
    <script>
      ...
      function bukaModal(kategori) {
        ...
        document.getElementById("kategori-detail").innerText =
          "Detail " + kategori;
