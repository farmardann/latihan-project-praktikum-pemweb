...
if(isset($_POST['simpan'])) {
    ...
    var_dump($photo, $categories, $prices, $description);

    $sql = "INSERT INTO tb_categories VALUES(NULL, '$photo', '$categories', '$prices','$description')";

    if(empty($categories) || empty($prices)|| empty($description)) {
        echo "
            <script>
